...
`;var k={chat:tt,close:et,send:rt,mic:nt,micOff:at,thinking:'<div class="at-thinking-dots"><span></span><span></span><span></span></div>'};function M(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function T(e,t,n){let a=document.createElement(e);return a.className=t,n!==void 0&&(a.innerHTML=n),a}function F(){return!!(navigator.mediaDevices&&navigator.mediaDevices.getUserMedia)}function it(e,t){let n=t.position==="left"?"at-left":"at-right",a=T("button","at-trigger "+n,k.chat);a.setAttribute("aria-label",t.lang==="ru"?"\u041E\u0442\u043A\u0440\u044B\u0442\u044C \u0447\u0430\u0442":"Open chat"),a.title=a.getAttribute("aria-label"),e.appendChild(a);let r=T("div","at-panel "+n+" at-hidden");e.appendChild(r);let i=T("div","at-head"),o=T("div","at-head-info");o.innerHTML="<strong>"+M(t.title)+"</strong><span>"+M(t.agent)+"</span>";let c=T("div","at-head-status");c.innerHTML='<span class="at-dot"></span> '+(t.lang==="ru","Online"),o.appendChild(c);let h=T("button","at-close",k.close);h.setAttribute("aria-label",t.lang==="ru"?"\u0417\u0430\u043A\u0440\u044B\u0442\u044C \u0447\u0430\u0442":"Close chat"),i.appendChild(o),i.appendChild(h),r.appendChild(i);let u=T("div","at-messages");r.appendChild(u);let g=document.createElement("form");g.className="at-form";let f=document.createElement("textarea");f.rows=1,f.placeholder=t.placeholder,f.setAttribute("aria-label",t.placeholder),f.style.height="38px";let x=T("button","at-mic-btn",k.mic);x.type="button",x.setAttribute("aria-label",t.lang==="ru"?"\u0417\u0430\u0436\u043C\u0438\u0442\u0435 \u0434\u043B\u044F \u0437\u0430\u043F\u0438\u0441\u0438":"Hold to record"),x.title=x.getAttribute("aria-label");let w=T("button","at-send-btn",k.send);w.type="submit",w.setAttribute("aria-label",t.lang==="ru"?"\u041E\u0442\u043F\u0440\u0430\u0432\u0438\u0442\u044C":"Send");let s=t.voiceToggle==="telegram"&&t.voiceInput&&F(),m=T("div","at-swap-btn "+(s?"at-show-mic":"at-show-send"));m.appendChild(x),m.appendChild(w),!s&&t.voiceInput&&F()&&m.classList.add("at-legacy"),(!t.voiceInput||!F())&&(x.style.display="none");let b=T("div","at-form-row");b.appendChild(f),b.appendChild(m),g.appendChild(b);let L=T("div","at-mic-timer");return g.insertBefore(L,b),r.appendChild(g),{trigger:a,panel:r,messages:u,form:g,textarea:f,closeBtn:h,sendBtn:w,head:i,micBtn:x,micTimer:L,swapBtn:m}}function _(e){return e.classList.contains("at-msg-row")?e.querySelector(".at-msg")||e:(e.classList.contains("at-msg"),e)}function st(e){let t=e.closest(".at-msg-row");if(t){t.remove();return}e.remove()}function S(e){e&&(e.scrollTop=e.scrollHeight)}function ot(e){return!!(e&&e.scrollHeight-e.scrollTop-e.clientHeight<48)}function B(e){let t=[],n=(e||"").split(`
...
`)).replace(/\n/g,"<br>")+"</p>"),a<n.length&&!n[a].trim()&&a++}return t.join("")}function lt(e,t){let n=e[t],a=e[t+1];return!n||!a?!1:n.trim().charAt(0)==="|"&&/^\|?\s*:?-{3,}:?\s*(\|\s*:?-{3,}:?\s*)+\|?$/.test(a)}function Mt(e){let t=[];for(let r=0;r<e.length;r++){let i=e[r];if(/^\|?\s*:?-{3,}:?\s*(\|\s*:?-{3,}:?\s*)+\|?$/.test(i))continue;let o=i.trim().replace(/^\|/,"").replace(/\|$/,"").split("|").map(c=>c.trim());t.push(o)}if(!t.length)return"";let n=t[0],a=t.slice(1);return'<div class="at-table-wrap"><table><thead><tr>'+n.map(r=>"<th>"+D(r)+"</th>").join("")+"</tr></thead><tbody>"+a.map(r=>"<tr>"+r.map(i=>"<td>"+D(i)+"</td>").join("")+"</tr>").join("")+"</tbody></table></div>"}var Lt=new Set(["http","https","mailto"]);function Ct(e){var a;let t=(a=e.replace(/^\s+/,"").split(/[/?#]/,1)[0])!=null?a:"";if(!t.includes(":"))return!0;let n=t.replace(/\s+/g,"").split(":",1)[0].toLowerCase();return/^[a-z][a-z0-9+.-]*$/.test(n)&&Lt.has(n)}function D(e){return M(e).replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>").replace(/\*([^*]+)\*/g,"<em>$1</em>").replace(/`([^`]+)`/g,"<code>$1</code>").replace(/\[([^\]]+)\]\(([^)]+)\)/g,(t,n,a)=>Ct(a)?`<a href="${a}" target="_blank" rel="noopener noreferrer">${n}</a>`:n)}function ct(e){let t=e.toLowerCase();return/поиск|найти|find|search/i.test(t)?"\u{1F50D}":/чтение|get|получени/i.test(t)?"\u{1F4CB}":/запрос|query/i.test(t)?"\u{1F4CA}":/list|список/i.test(t)?"\u{1F4CB}":"\u26A1"}function A(e,t){let n=t||{},a=[...new Set(e)];if(!a.length)return null;let r=document.createElement("div");return r.className="at-tool-strip",r.innerHTML=a.map(i=>{let o=n[i]||i;return`<span>${ct(o)} ${M(o)}</span>`}).join(""),r}function N(e,t,n,a){var h;let r=[...new Set(t)];if(!r.length)return;let i=((h=e.closest)==null?void 0:h.call(e,".at-msg-row"))||e,o=i.previousElementSibling;if(o&&o.className==="at-tool-strip"){o.innerHTML=r.map(u=>{let g=n[u]||u;return`<span>${ct(g)} ${M(g)}</span>`}).join("");return}let c=A(r,n);c&&a.insertBefore(c,i)}function dt(e,t,n,a){let r=a||{};if(e==="assistant"){let i=document.createElement("div");i.className="at-msg-row";let o=document.createElement("div");o.className="at-avatar",o.textContent="AI";let c=document.createElement("div");c.className="at-msg at-assistant",r.thinking?(c.dataset.raw="",c.innerHTML=k.thinking):(c.dataset.raw=t||"",c.innerHTML=B(t||"")),i.appendChild(c),i.appendChild(o),r.before?n.insertBefore(i,r.before):n.appendChild(i)}else{let i=document.createElement("div");i.className="at-msg at-user",i.textContent=t||"",r.before?n.insertBefore(i,r.before):n.appendChild(i)}return r.scroll!==!1&&S(n),n.lastElementChild}function V(e,t,n,a){let r=n();if(!r.length){a("assistant",e.greeting,{persist:!1,scroll:!1});return}t.innerHTML="";let i=[];for(let o of r)if(o.kind==="user")a("user",o.text,{persist:!1,scroll:!1});else if(o.kind==="assistant"){let c=(o.tools||[]).filter(Boolean),h=String(o.text||"");if(!h.trim()&&c.length>0){i=i.concat(c);continue}let u=i.concat(c);if(i=[],u.length>0){let w=A(u);w&&t.appendChild(w)}let g=document.createElement("div");g.className="at-msg-row";let f=document.createElement("div");f.className="at-avatar",f.textContent="AI";let x=document.createElement("div");x.className="at-msg at-assistant",x.dataset.raw=h,x.innerHTML=B(h),g.appendChild(x),g.appendChild(f),t.appendChild(g)}if(i.length>0){let o=A(i);o&&t.appendChild(o)}S(t)}async function $(e,t,n,a="en"){var h;let r=e.body.getReader(),i=new TextDecoder,o="",c=!1;for(;;){let{done:u,value:g}=await r.read();if(u)break;o+=i.decode(g,{stream:!0});let f=o.split(`

`);o=f.pop();for(let x of f){let w=x.split(`
`).find(m=>m.startsWith("data:"));if(!w)continue;let s;try{s=JSON.parse(w.slice(5).trim())}catch(m){continue}switch(t.classList.contains("at-thinking")&&t.classList.remove("at-thinking"),s.type){case"token":n.onToken(s.text||"");break;case"final":c=!0,n.onFinal(s.text||"");break;case"tool_call":{let b=JSON.parse(t.dataset.tools||"[]"),L=JSON.parse(t.dataset.displayNames||"{}");s.name&&!b.includes(s.name)&&(b.push(s.name),t.dataset.tools=JSON.stringify(b)),s.display_name&&s.name&&!L[s.name]&&(L[s.name]=s.display_name,t.dataset.displayNames=JSON.stringify(L)),n.onToolCall(s.name||"",s.display_name);break}case"audio":s.data&&n.onAudio(s.data);break;case"done":if(c=!0,t.classList.contains("at-error"))return;(h=t.dataset.raw)!=null&&h.trim()||n.onFinal(a==="ru"?"\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u043F\u043E\u043B\u0443\u0447\u0438\u0442\u044C \u043E\u0442\u0432\u0435\u0442.":"No response.");let m=[];try{m=JSON.parse(t.dataset.tools||"[]")}catch(b){}n.onDone(t.dataset.raw||"",m),t.dataset.saved="true";break;case"error":c=!0,t.classList.remove("at-thinking"),t.classList.add("at-error"),t.textContent=s.text||(a==="ru"?"\u041F\u0440\u043E\u0438\u0437\u043E\u0448\u043B\u0430 \u043E\u0448\u0438\u0431\u043A\u0430.":"An error occurred.");break}}}c||n.onError(a==="ru"?"\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u043F\u043E\u043B\u0443\u0447\u0438\u0442\u044C \u043E\u0442\u0432\u0435\u0442.":"No response.")}function W(e){let{message:t,targetNode:n,config:a,sessionId:r,messagesEl:i,retryAttempts:o,maxRetries:c,callbacks:h,removeMsgRow:u,scheduleRetry:g,retryChat:f,scrollToBottom:x}=e;n.classList.add("at-thinking");let w=a.apiBase+"/api/chat/"+encodeURIComponent(a.agent);fetch(w,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({message:t,session_id:r})}).then(s=>{if(s.status===429){n.classList.remove("at-thinking"),u(n);let m=s.headers.get("Retry-After"),b=5;if(m){let y=parseInt(m,10);!isNaN(y)&&y>0&&(b=y)}if(o.set(t,(o.get(t)||0)+1),o.get(t)>=c){let y=document.createElement("div");y.className="at-msg at-assistant at-error",y.innerHTML="\u26A0\uFE0F Server overloaded.";let E=document.createElement("button");E.className="at-retry-btn",E.textContent="Retry",y.appendChild(E),i.appendChild(y),x(i),E.addEventListener("click",()=>{o.delete(t),y.remove(),f(t)});return}let R=document.createElement("div");R.className="at-msg at-assistant",R.textContent="\u26A0\uFE0F "+(a.lang==="ru"?"\u0421\u0435\u0440\u0432\u0435\u0440 \u043F\u0435\u0440\u0435\u0433\u0440\u0443\u0436\u0435\u043D. \u041F\u043E\u0432\u0442\u043E\u0440 \u0447\u0435\u0440\u0435\u0437":"Server overloaded. Retry in")+" "+b+"s.",i.appendChild(R),x(i),g(t,b*1e3);return}if(!s.ok){n.classList.remove("at-thinking"),n.classList.add("at-error"),n.textContent="Error: "+s.status;return}return $(s,n,h,a.lang)}).catch(()=>{n.classList.remove("at-thinking"),n.classList.add("at-error"),n.innerHTML="\u26A0\uFE0F "+(a.lang==="ru"?"\u041D\u0435\u0442 \u0441\u043E\u0435\u0434\u0438\u043D\u0435\u043D\u0438\u044F \u0441 \u0441\u0435\u0440\u0432\u0435\u0440\u043E\u043C.":"No connection to server.")+'<br><button class="at-retry-btn">'+(a.lang==="ru"?"\u041F\u043E\u0432\u0442\u043E\u0440\u0438\u0442\u044C":"Retry")+"</button>";let s=n.querySelector(".at-retry-btn");s&&s.addEventListener("click",()=>{n.classList.remove("at-error"),n.innerHTML=k.thinking,W(e)})})}function j(e){try{let n=sessionStorage.getItem(e);if(n)return n}catch(n){}let t=typeof crypto!="undefined"&&crypto.randomUUID?crypto.randomUUID():"sess-"+Date.now()+"-"+Math.random().toString(36).slice(2,10);try{sessionStorage.setItem(e,t)}catch(n){}return t}function pt(e){try{let t=sessionStorage.getItem(e);if(!t)return[];let n=JSON.parse(t);return Array.isArray(n)?n:[]}catch(t){return[]}}function gt(e,t){try{sessionStorage.setItem(e,JSON.stringify(t))}catch(n){}}function U(e,t){function n(){return pt(e).filter(i=>i.sessionId===t).map(i=>({kind:i.kind,text:i.text,tools:i.tools||[]}))}function a(r,i,o){let c=pt(e);c.push({sessionId:t,kind:r,text:String(i||""),tools:o||[],ts:Date.now()});let h=c.filter(u=>u.sessionId===t);if(h.length>100){let u=h.length-100,g=0,f=c.filter(x=>x.sessionId===t&&g<u?(g++,!1):!0);gt(e,f);return}gt(e,c)}return{readStored:n,appendStored:a}}var Et=20,Ht=3;function Y(e,t,n){let a=e.dataset.raw||"";e.dataset.raw=a+t,e.dataset.typewriterRunning?e.dataset.typewriterBuffer=(e.dataset.typewriterBuffer||"")+t:(e.dataset.typewriterRunning="1",e.dataset.typewriterBuffer=a+t,e.dataset.typewriterDisplayed=a,mt(e,n))}function mt(e,t){let n=e.dataset.typewriterBuffer||"",a=e.dataset.typewriterDisplayed||"";if(a.length>=n.length){e.dataset.typewriterRunning="",e.innerHTML=B(n),S(t);return}let r=Math.min(Ht,n.length-a.length),i=n.slice(0,a.length+r);e.dataset.typewriterDisplayed=i;let o=B(i);if(i.length<n.length)e.classList.add("at-typing-cursor"),e.innerHTML=o;else{e.classList.remove("at-typing-cursor"),e.innerHTML=o,e.dataset.typewriterRunning="",S(t);return}ot(t)&&S(t),setTimeout(()=>mt(e,t),Et)}function J(e,t){e.classList.remove("at-thinking"),e.dataset.raw=t,e.innerHTML=B(t)}var ut=120,Bt="audio/webm;codecs=opus",Rt="audio/webm";function ht(){return{mediaRecorder:null,micChunks:[],micStream:null,micStartTime:0,micDuration:0,micTimerInterval:null}}function ft(e,t){e.micDuration=Math.floor((Date.now()-e.micStartTime)/1e3);let n=Math.floor(e.micDuration/60),a=e.micDuration%60;t.textContent=(n>0?n+"m ":"")+a+"s"}function I(e,t){if(!(e.mediaRecorder&&e.mediaRecorder.state==="recording")){if(!navigator.mediaDevices||!navigator.mediaDevices.getUserMedia){t.micBtn.classList.add("at-mic-disabled");return}navigator.mediaDevices.getUserMedia({audio:!0}).then(n=>{e.micStream=n,e.micChunks=[];let a=Bt;MediaRecorder.isTypeSupported(a)||(a=Rt),e.mediaRecorder=new MediaRecorder(n,{mimeType:a}),e.mediaRecorder.ondataavailable=r=>{r.data.size>0&&e.micChunks.push(r.data)},e.mediaRecorder.onstop=()=>{n.getTracks().forEach(c=>c.stop()),e.micStream=null,t.micBtn.innerHTML=k.mic,t.micBtn.classList.remove("at-mic-recording"),t.micTimer.classList.remove("at-mic-timer-visible"),e.micTimerInterval&&(clearInterval(e.micTimerInterval),e.micTimerInterval=null);let r=new Blob(e.micChunks,{type:a});if(r.size===0)return;let i=t.micTimer.textContent||e.micDuration+"s";t.addMessage("user","\u{1F3A4} "+i,{persist:!0});let o=t.addMessage("assistant","",{thinking:!0,persist:!1,scroll:!1});t.onStreamVoice(r,o)},e.mediaRecorder.start(),t.micBtn.innerHTML=k.micOff,t.micBtn.classList.add("at-mic-recording"),t.micTimer.classList.add("at-mic-timer-visible"),e.micStartTime=Date.now(),e.micDuration=0,ft(e,t.micTimer),e.micTimerInterval=window.setInterval(()=>ft(e,t.micTimer),1e3),ut>0&&setTimeout(()=>{e.mediaRecorder&&e.mediaRecorder.state==="recording"&&e.mediaRecorder.stop()},ut*1e3)}).catch(n=>{n.name==="NotAllowedError"||n.name==="PermissionDeniedError"?t.addMessage("assistant",t.config.lang==="ru"?"\u274C \u0420\u0430\u0437\u0440\u0435\u0448\u0438\u0442\u0435 \u0434\u043E\u0441\u0442\u0443\u043F \u043A \u043C\u0438\u043A\u0440\u043E\u0444\u043E\u043D\u0443 \u0432 \u043D\u0430\u0441\u0442\u0440\u043E\u0439\u043A\u0430\u0445 \u0431\u0440\u0430\u0443\u0437\u0435\u0440\u0430":"\u274C Please allow microphone access in browser settings",{persist:!1}):t.micBtn.classList.add("at-mic-disabled")})}}function P(e){e.mediaRecorder&&e.mediaRecorder.state==="recording"&&e.mediaRecorder.stop()}function bt(e,t,n){t.classList.add("at-thinking");let a=n.config.apiBase+"/api/chat/voice",r=new FormData;r.append("audio",e,"voice.webm"),r.append("session_id",n.sessionId),r.append("agent",n.config.agent),r.append("lang",n.config.lang),fetch(a,{method:"POST",body:r}).then(i=>{if(i.status===429){t.classList.remove("at-thinking"),t.remove();let o=document.createElement("div");o.className="at-msg at-assistant",o.textContent=n.config.lang==="ru"?"\u26A0\uFE0F \u0421\u0435\u0440\u0432\u0435\u0440 \u043F\u0435\u0440\u0435\u0433\u0440\u0443\u0436\u0435\u043D. \u041F\u043E\u043F\u0440\u043E\u0431\u0443\u0439\u0442\u0435 \u043F\u043E\u0437\u0436\u0435.":"\u26A0\uFE0F Server overloaded. Try again later.",n.messagesEl.appendChild(o),n.scrollToBottom(n.messagesEl);return}if(!i.ok){t.classList.remove("at-thinking"),t.classList.add("at-error"),t.textContent="Error: "+i.status;return}return $(i,t,n.callbacks,n.config.lang)}).catch(()=>{t.classList.remove("at-thinking"),t.classList.add("at-error"),t.innerHTML="\u26A0\uFE0F "+(n.config.lang==="ru"?"\u041E\u0448\u0438\u0431\u043A\u0430 \u0441\u043E\u0435\u0434\u0438\u043D\u0435\u043D\u0438\u044F.":"Connection error.")})}function q(e){try{let t=atob(e),n=new Uint8Array(t.length);for(let o=0;o<t.length;o++)n[o]=t.charCodeAt(o);let a=new Blob([n],{type:"audio/mpeg"}),r=URL.createObjectURL(a);new Audio(r).play().catch(()=>{})}catch(t){}}var Dt=3;function At(){let e=document.currentScript;if(e&&e instanceof HTMLScriptElement)return e;let t=document.querySelector("script[data-agent]");if(t)return t;let n=document.querySelector('script[src*="embed.js"]');return n||null}function It(e){let t=e.replace("#",""),n=parseInt(t.length===3?t.split("").map(a=>a+a).join(""):t,16);return`${n>>16&255}, ${n>>8&255}, ${n&255}`}function Ot(e){let t=e.headerColor||e.accent;return`:host {
  --accent: ${e.accent};
...
${e.showHeader?"":".at-head { display: none; }"}`}function xt(){var K,X;let e=At(),t=Q(e);if(!t.agent)return;let n,a,r,i="at_messages_"+t.agent,o="at_session_"+t.agent;r=j(o),{readStored:n,appendStored:a}=U(i,r);let c=ht(),h=new Map,u=document.createElement("div");u.id="helperium-widget-"+t.agent.replace(/[^a-zA-Z0-9_-]/g,"");let g=u.attachShadow({mode:"open"}),f=document.createElement("style");f.textContent=Z,g.appendChild(f);let x=document.createElement("style");x.textContent=Ot(t),g.appendChild(x);let w=document.createElement("div");w.className="at-root",g.appendChild(w);let s=it(w,t),m=s.messages;function b(d,p,l){let v=dt(d,p,m,l);return l!=null&&l.persist&&a(d,p,l.tools),v}function L(d,p){let l=Math.ceil(p/1e3),v=document.createElement("div");v.className="at-msg at-retry-countdown",v.textContent=(t.lang==="ru"?"\u041F\u043E\u0432\u0442\u043E\u0440 \u0447\u0435\u0440\u0435\u0437":"Retry in")+" "+l+"s...",m.appendChild(v),S(m);let C=setInterval(()=>{l--,l<=0?(clearInterval(C),v.remove(),R(d)):v.textContent=(t.lang==="ru"?"\u041F\u043E\u0432\u0442\u043E\u0440 \u0447\u0435\u0440\u0435\u0437":"Retry in")+" "+l+"s..."},1e3)}function R(d){let p=b("assistant","",{thinking:!0,persist:!1,scroll:!1}),l=_(p);y(d,l)}function y(d,p){W({message:d,targetNode:p,config:t,sessionId:r,messagesEl:m,retryAttempts:h,maxRetries:Dt,callbacks:{onToken:l=>Y(p,l,m),onFinal:l=>J(p,l),onToolCall:(l,v)=>{let C=JSON.parse(p.dataset.tools||"[]"),H=JSON.parse(p.dataset.displayNames||"{}");C.includes(l)||(C.push(l),p.dataset.tools=JSON.stringify(C)),v&&!H[l]&&(H[l]=v,p.dataset.displayNames=JSON.stringify(H)),N(p,C,H,m)},onAudio:l=>q(l),onDone:(l,v)=>{a("assistant",l,v)},onError:l=>{p.classList.remove("at-thinking"),p.classList.add("at-error"),p.textContent=l}},addMessage:b,removeMsgRow:st,scheduleRetry:(l,v)=>L(l,v),retryChat:R,scrollToBottom:S})}s.trigger.addEventListener("click",()=>{s.panel.classList.remove("at-hidden"),s.trigger.style.display="none",s.textarea.focus(),S(m)}),s.closeBtn.addEventListener("click",()=>{s.panel.classList.add("at-hidden"),s.trigger.style.display="flex"});function E(){let d=s.textarea.value.trim();if(!d)return;s.textarea.value="",s.textarea.style.height="auto",G(),b("user",d,{persist:!0});let p=b("assistant","",{thinking:!0,persist:!1,scroll:!1}),l=_(p);y(d,l)}s.textarea.addEventListener("input",function(){this.style.height="auto",this.style.height=Math.min(this.scrollHeight,120)+"px",G()}),s.textarea.addEventListener("keydown",d=>{d.key==="Enter"&&!d.shiftKey&&(d.preventDefault(),E())}),s.form.addEventListener("submit",d=>{d.preventDefault(),E()});function G(){if(t.voiceToggle!=="telegram"||!O)return;s.textarea.value.trim().length>0?(s.swapBtn.classList.remove("at-show-mic"),s.swapBtn.classList.add("at-show-send")):(s.swapBtn.classList.remove("at-show-send"),s.swapBtn.classList.add("at-show-mic"))}let O=t.voiceInput&&typeof((K=navigator.mediaDevices)==null?void 0:K.getUserMedia)=="function";if(t.voiceToggle==="telegram"&&O){let d=!1;s.micBtn.addEventListener("mousedown",l=>{l.preventDefault(),!d&&(d=!0,s.micBtn.classList.add("at-mic-holding"),I(c,{micBtn:s.micBtn,micTimer:s.micTimer,config:t,sessionId:r,addMessage:b,onStreamVoice:z(),onStreamChat:y}))});let p=()=>{d&&(d=!1,s.micBtn.classList.remove("at-mic-holding"),P(c))};s.micBtn.addEventListener("mouseup",p),s.micBtn.addEventListener("mouseleave",p),s.micBtn.addEventListener("touchstart",l=>{l.preventDefault(),!d&&(d=!0,s.micBtn.classList.add("at-mic-holding"),I(c,{micBtn:s.micBtn,micTimer:s.micTimer,config:t,sessionId:r,addMessage:b,onStreamVoice:z(),onStreamChat:y}))},{passive:!1}),s.micBtn.addEventListener("touchend",p),s.micBtn.addEventListener("touchcancel",p)}else O&&(s.micBtn.style.display="flex",s.micBtn.addEventListener("mousedown",d=>{d.preventDefault(),s.micBtn.classList.contains("at-mic-recording")?P(c):I(c,{micBtn:s.micBtn,micTimer:s.micTimer,config:t,sessionId:r,addMessage:b,onStreamVoice:z(),onStreamChat:y})}));function z(){return(d,p)=>{bt(d,p,{config:t,sessionId:r,messagesEl:m,callbacks:{onToken:l=>Y(p,l,m),onFinal:l=>J(p,l),onToolCall:(l,v)=>{N(p,[l],v?{[l]:v}:{},m)},onAudio:l=>q(l),onDone:(l,v)=>{a("assistant",l,v)},onError:l=>{p.classList.remove("at-thinking"),p.classList.add("at-error"),p.textContent=l}},scrollToBottom:S})}}V(t,m,n,b),document.body.appendChild(u),window.__agentTutorSetAgent=d=>{if(!d)return;t.agent=d;let p="at_messages_"+d,l="at_session_"+d,v=j(l),C=U(p,v);n=C.readStored,a=C.appendStored,r=v;let H=s.head.querySelector(".at-head-info");H&&(H.innerHTML="<strong>"+M(t.title)+"</strong><span>"+M(d)+"</span>"),m.innerHTML="",V(t,m,n,b);try{localStorage.setItem("agentTutorAgentId",d)}catch(zt){}};try{let d=localStorage.getItem("agentTutorAgentId");d&&t.agent!==d&&((X=window.__agentTutorSetAgent)==null||X.call(window,d))}catch(d){}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",xt):xt();})();
