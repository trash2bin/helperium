# DEV-ONLY
Данные утилиты используется только для разработки и тестирования баз данных будь то SQLite, Postgres, Chromadb или иное чисто для заполнения их фековой информацие, контейнер под это не требуется.
