...
| Независимый PM/технический аудит, готовность к пилоту | 📖 `doc/agents/product-readiness-audit-2026-08-18-head-0a6aff5` → 📖 `doc/agents/product-readiness-audit-2026-08-18-head-14d3758` → 📖 `doc/agents/product-readiness-audit-2026-08-18` → 📖 `doc/agents/remediation-plan-2026-08-18` → 🔧 `doc/benchmark/core-benchmark` → 🔧 `doc/agents/testing-guide` | 📖→🔧 |
...
| `doc/agents/product-readiness-audit-2026-08-18-head-0a6aff5.md` | Независимый PM/QA-аудит текущего `main` HEAD `0a6aff5`: benchmark, native onboarding, E2E, demo и Admin runtime (2026-08-18) | 📖 актуальный release verdict: NO-GO |
| `doc/agents/production-resilience-audit-2026-08-18-head-bd5adb5.md` | Практический аудит resilience/observability HEAD `bd5adb5`: восстановление, proxy/rate-limit дефекты и pre-prod gates (2026-08-18) | 📖 актуальный resilience verdict: attended pre-prod only |
| `doc/agents/product-readiness-audit-2026-08-18-head-14d3758.md` | Независимый PM/QA-аудит HEAD `14d3758`: benchmark, E2E/CI, native onboarding, demo и Admin runtime (2026-08-18) | 🗃️ архив: предыдущий release verdict |
...
2026-08-18 (HEAD 0a6aff5) — добавлен независимый аудит `doc/agents/product-readiness-audit-2026-08-18-head-0a6aff5.md`: подтверждён воспроизводимый native P0 read-only SQLite onboarding (HTTP 500: write PRAGMA на обычном DSN), full native E2E red (20 failed / 12 passed / 99 errors), configured demo `autoparts` отсутствует в runtime. Benchmark harness 107/107, Go suites и Admin 73 tests зелёные; live KPI остаётся историческим. Новый audit добавлен в маршруты и каталог.
| `doc/agents/production-resilience-audit-2026-08-18-head-bd5adb5.md` | Практический аудит resilience/observability HEAD `bd5adb5`: восстановление, proxy/rate-limit дефекты и pre-prod gates (2026-08-18) | 📖 актуальный resilience verdict: attended pre-prod only |
